...
const mockRecentActivities = [
  ...
  },
  {
    id: '3',
    type: 'learning',
    title: 'Watched video: Advanced TypeScript',
      ...
      <Container maxWidth="lg">
        ...
        <Paper sx={{ mb: 3, p: 3, borderRadius: 2 }}>
          <Grid container spacing={3} alignItems="center">
            ...
            <Grid item xs>
              <Typography variant="h6" sx={{ color: terraColors.prussianBlue }}>
                {user.name}
              </Typography>
              <Typography variant="body2" sx={{ color: terraColors.maastrichtBlue }}>
                {user.email}
              </Typography>
              <Typography variant="caption" sx={{ color: terraColors.softTeal }}>
