...
}, (req: JWTRequest & { file?: Express.Multer.File }, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
...
}, (req: JWTRequest & { files?: Express.Multer.File[] }, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
      const { userId } = req.body;
      const { category, relatedEntityId } = req.query;
...
// Get file info
router.get('/file/:blobName', checkJwt, extractUserId, (req: JWTRequest, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
...
router.get('/files', checkJwt, extractUserId, (req: JWTRequest, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
...
// Delete a file
router.delete('/file/:id', checkJwt, extractUserId, (req: JWTRequest, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
      const { userId } = req.body;
...
// Get files by user
router.get('/user-files', checkJwt, extractUserId, (req: JWTRequest, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
      const { userId } = req.body;
...
router.get('/entity-files/:entityId', checkJwt, extractUserId, (req: JWTRequest, res: express.Response, next: express.NextFunction) => {
  (async (): Promise<void> => {
    try {
      const { userId } = req.body;
